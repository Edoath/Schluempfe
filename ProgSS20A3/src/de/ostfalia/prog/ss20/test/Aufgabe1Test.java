...
@AddOnVersion("4.5.3")
@Integrity("da11a76bb81ade4ce23c0de31823d824")
public class Aufgabe1Test {
	...
	public void testZweiInstanzen() throws Exception {
		...
		String stellung = "GELB-A:21, GELB-B:30, GELB-C:0, GELB-D:0, GRUEN-A:19, "
				        + "GRUEN-B:0, GRUEN-C:0, GRUEN-D:0, Bzz:28:Z, Doc:29";
		...
		evaluate(z2, "GELB-A:21", "GELB-B:30", "GELB-C:0", "GELB-D:0", "GRUEN-A:19", 
				     "GRUEN-B:0", "GRUEN-C:0", "GRUEN-D:0", "Bzz:28:Z", "Doc:29");
		...
		evaluate(z2, "GELB-A:21", "GELB-B:30", "GELB-C:0", "GELB-D:0", "GRUEN-A:21", 
				     "GRUEN-B:0", "GRUEN-C:0", "GRUEN-D:0", "Bzz:28:Z", "Doc:29");
		//-------------------------------------------------------------------------
